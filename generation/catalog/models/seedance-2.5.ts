...
export const seedance25Edit: ModelEntry = {
  ...
  order: 11,
  toPlatform: (plane) => mapSeedanceSource(plane, "bytedance/seedance-2.5/video-edit", false),
};
...
export const seedance25Extend: ModelEntry = {
  ...
  order: 12,
  toPlatform: (plane) => mapSeedanceSource(plane, "bytedance/seedance-2.5/video-extend", true),
};

export default [seedance25, seedance25Edit, seedance25Extend];
